...
public class AboutActivity extends WfcBaseActivity {
    ...
    public void intro() {
        WfcWebViewActivity.loadUrl(this, "JOB_IM功能介绍", "https://docs.wildfirechat.cn/");
    }

    public void agreement() {
        WfcWebViewActivity.loadUrl(this, "JOB_IM用户协议", "https://www.wildfirechat.net/wildfirechat_user_agreement.html");
    }

    public void privacy() {
        WfcWebViewActivity.loadUrl(this, "JOB_IM个人信息保护政策", "https://www.wildfirechat.net/wildfirechat_user_privacy.html");
    }
}
